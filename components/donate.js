  ...
  return (
    <section className="section is-light">
      <div className="container has-text-centered has-text-weight-semibold">
        <p className="title is-6">If you like Mockoon you can support me with a one-time donation:</p>
        <div>
          ...
          <div className="donate-item">
            <a className="bmc-button" target="_blank" href="https://www.buymeacoffee.com/255kb">
