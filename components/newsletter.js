  ...
  return (
    <section className="section is-light">
      <div className="container has-text-centered has-text-weight-semibold">
          ...
          <form action="https://mockoon.us17.list-manage.com/subscribe/post?u=a8822ec82cbe40c6dc5564bd4&amp;id=e054c8a3a4" method="post"
            ...
            <div id="mc_embed_signup_scroll">
              ...
              <div style={{ position: 'absolute', left: -5000 + 'px' }} aria-hidden="true">
                <input type="text" name="b_a8822ec82cbe40c6dc5564bd4_e054c8a3a4" tabIndex="-1" defaultValue="" />
              </div>
              <div className="clear">
                <input type="submit" defaultValue="Subscribe" name="subscribe" id="mc-embedded-subscribe" className="button" />
              </div>
              <div id="mce-responses" className="clear" style={{ float: 'none' }}>
        ...
        <a href="https://twitter.com/GetMockoon?ref_src=twsrc%5Etfw" className="twitter-follow-button" data-size="large" data-show-screen-name="false" data-dnt="true" data-show-count="false">Follow @GetMockoon</a>
      </div>
    </section>
  );
}
