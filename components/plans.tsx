      ...
      <section className='mb-8'>
        <div className='container'>
                ...
                <div className='card shadow-lg mb-6 mb-md-0 h-100'>
                  <div className='card-body h-100 d-flex flex-column'>
                    ...
                    <div className='text-center mb-6'>
                      <Link href={'/download/'}>
                        <a className='btn btn-primary-soft'>Download now</a>
                      </Link>
                    </div>
              ...
              <div className='card shadow-lg mb-6 mb-md-0 h-100'>
                <div className='card-body h-100 d-flex flex-column'>
                  ...
                  <div className='d-flex'>
                    ...
                    <p>
                      All of Mockoon's <Link href={'/features/'}>features</Link>
                    </p>
                  </div>
                  <div className='d-flex'>
                    <div className='badge badge-rounded-circle bg-success-soft mt-1 me-4'>
                ...
                <div className='card-body h-100 d-flex flex-column'>
                  ...
                  <div className='text-center'>
                    <Link href={'/contact-form/'}>
                      <a className='btn btn-primary-soft btn-sm my-6'>
                        Specific needs?
                        <br />
                        Contact sales
                      </a>
          ...
          <p className='fs-sm text-muted text-center mt-1'>
            Prices are in USD and exclude VAT where applicable. By proceeding to
            payment you agree to our{' '}
            <Link href={'/privacy/'}>privacy policy</Link> and{' '}
            <Link href={'/terms/'}>terms of service</Link>.<br />
            <sup>1</sup> Priority support is subject to SLAs, see our{' '}
            <Link href={'/terms/'}>terms of service</Link> for more information.
          </p>
