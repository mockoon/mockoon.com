...
![Cloud and local environments menus{200x231}](cloud-docs-img:cloud-sync-menu.png)
...
![context menus to create cloud environments{569x492}](cloud-docs-img:create-cloud-environment.png)
...
![context menu to convert a cloud environment to local{533x277}](cloud-docs-img:convert-cloud-to-local.png)
...
![Presence indicators{668x157}](cloud-docs-img:presence-indicators.png)
...
![#sub#Tooltip showing a regular disconnection{287x219}](cloud-docs-img:offline-reason-disconnected.png)

![#sub#Tooltip showing a disconnection due to an incompatible version{288x221}](cloud-docs-img:offline-reason-incompatible-version.png)
