...
![modal with templates list{498x335}](cloud-docs-img:pre-generated-templates-modal.png)
...
![create get route from template{860x801}](cloud-docs-img:templates-create-get-route.png)
...
![AI assistant generate tab{860x801}](cloud-docs-img:ai-assistant-generate-template-tab.png)

Then, **write a prompt** (e.g. "list of users") and click the "Generate" button.

![AI assistant generate button click{860x801}](cloud-docs-img:ai-assistant-generate-button.png)
...
![create get route from template{860x801}](cloud-docs-img:templates-generate-get-route.png)
...
![AI assistant generate endpoint tab{860x801}](cloud-docs-img:ai-assistant-generate-endpoint-tab.png)

Then, **write a prompt** (e.g. "Get a list of users") and click the "Generate" button.

![AI assistant generate endpoint button click{860x801}](cloud-docs-img:ai-assistant-generate-endpoint-button.png)

Finally, you can click on the **"Create HTTP route"** button to create a new endpoint from the generated data.

![create full route from generated result{860x801}](cloud-docs-img:ai-assistant-generate-endpoint-create-button.png)
...
![prompt templating option button{860x801}](cloud-docs-img:ai-assistant-template-generate-option.png)
