...
![modal with templates list](docs-img:pre-generated-templates-modal.png)
...
![create get route from template](docs-img:templates-create-get-route.png)
...
![AI assistant generate tab](docs-img:ai-assistant-generate-template-tab.png)

Then, write a prompt (e.g. "list of users") and click the "Generate" button.

![AI assistant generate button click](docs-img:ai-assistant-generate-button.png)
...
![create get route from template](docs-img:templates-generate-get-route.png)
...
![prompt options buttons](docs-img:ai-assistant-template-generate-options.png)
