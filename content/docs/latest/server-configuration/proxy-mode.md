...
![tick the Proxy checkbox{1484x277}](docs-img:enable-proxy.png)
...
![tick the Proxy no prefix forward checkbox{746x320}](docs-img:proxy-no-forward.png)

## Proxy headers

Proxy specific headers can also be added, both to the forwarded request and the response received from the target API.

![add proxy headers by filling the keys and values{1484x379}](docs-img:proxy-headers.png)
