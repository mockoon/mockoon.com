...
![click on route response fourth settings tab{769x191}](/images/docs/v1.17.0/open-route-response-settings.png)

Then, disable the templating by checking the box:

![check the disable templating box{769x191}](/images/docs/v1.17.0/disable-route-response-templating.png)
...
![add a templating helper in the header value{762x165}](/images/docs/v1.17.0/headers-templating.png)
