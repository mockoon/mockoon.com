...
![click on proxy tab{885x206}](/images/docs/v1.17.0/open-proxy-options.png)
...
![tick the Proxy checkbox{1284x304}](/images/docs/v1.17.0/enable-proxy.png)
...
![tick the Proxy no prefix forward checkbox{1284x304}](/images/docs/v1.17.0/proxy-no-forward.png)

## Proxy headers

Proxy specific headers can also be added, both to the forwarded request and the response received from the target API.

![add proxy headers by filling the keys and values{1284x304}](/images/docs/v1.17.0/proxy-headers.png)
