...
![deployment dialog{955x377}](docs-img:deploy-environment-dialog.png)
...
![deployment management dialog{953x239}](docs-img:deploy-environment-management-dialog.png)
...
![deployment management dialog re-deploy or delete the instance menu{1069x269}](docs-img:deploy-environment-management-menu.png)
