...
> The GUI cheat sheet is also available in PDF version <a href="/images/docs/shared/cheat-sheet/mockoon-cheat-sheet.pdf" className="btn btn-primary-desat-subtle btn-xs"><i className='icon-file_download'></i>&nbsp;Download</a>
