...
- Support was dropped for [legacy data files](https://mockoon.com/blog/new-storage-system-git-data-sharing/#the-old-system) in both Desktop and CLI. If you are updating from v1.15.0, please first update to any version between v1.16.0 and v4.1.0, then to v5.0.0.
...
- **Breaking change**: Support was dropped for opening [legacy data files](https://mockoon.com/blog/new-storage-system-git-data-sharing/#the-old-system) (pre v1.16.0). (Issue [#1138](https://github.com/mockoon/mockoon/issues/1138))
