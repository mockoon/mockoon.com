...
> You can find on our repository all the following examples ready to use! <a href="https://github.com/mockoon/mock-samples/blob/main/samples/generate-mock-data.json" className="btn btn-primary-desat-subtle btn-xs"><i className='icon-file_download'></i>&nbsp;Download</a>
>
...
> Remember, you can find all this tutorial's examples ready to use on our repository! <a href="https://github.com/mockoon/mock-samples/blob/main/samples/generate-mock-data.json" className="btn btn-primary-desat-subtle btn-xs"><i className='icon-file_download'></i>&nbsp;Download</a>
>
> To open the file, please [follow the instructions](https://github.com/mockoon/mock-samples#how-to-open-the-samples-in-mockoon).
