    ...
    value: function render() {
      return __jsx(_layout_layout__WEBPACK_IMPORTED_MODULE_10__["default"], {
        ...
        onClick: function onClick(event) {
          ...
          window.open('http://twitter.com/share?url=https://mockoon.com&amp;text=Mockoon+is+the+easiest+and+quickest+way+to+run+mock+APIs+locally.+No+remote+deployment,+no+account+required,+open+source.&amp;via=GetMockoon&amp;', 'twitter-share', 'width=800,height=600');
          return false;
        },
...
//# sourceMappingURL=index.js.0723066501af994b069e.hot-update.js.map