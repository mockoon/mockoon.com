...
function DynamicResponseWithTemplating() {
  return __jsx(_components_tutorial__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    __self: this
  }, "someOf (array 'item1' 'item2' 'item3') x y"), ": select x to y random items in the array passed in parameters (to be used with double curly braces), result is the following: ", __jsx("code", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
    ...
    __self: this
  }, "{{{someOf (array 'item1' 'item2' 'item3') x y true}}}"), ": select x to y random items in the array passed in parameters (to be used with double curly braces), result is the following: ", __jsx("code", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
    },
    ...
    __self: this
  }), "   \"someItems\": \"{{ someOf (array 'item1' 'item2' 'item3') 1 2 }}\",", __jsx("br", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 36
    },
...
//# sourceMappingURL=dynamic-response-with-templating.js.843a2058c9c2423f41d7.hot-update.js.map