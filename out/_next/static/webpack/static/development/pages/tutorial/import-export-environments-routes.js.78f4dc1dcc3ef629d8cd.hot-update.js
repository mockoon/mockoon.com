...
function ImportExportEnvironmentsRoutes() {
  return __jsx(_components_tutorial__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    __self: this
  }, "Prior to v1.7.0, data exported through the clipboard method was not compatible with import from file and vice versa. Also, exported data from one version couldn't be imported to another version of Mockoon.")));
}
...
//# sourceMappingURL=import-export-environments-routes.js.78f4dc1dcc3ef629d8cd.hot-update.js.map