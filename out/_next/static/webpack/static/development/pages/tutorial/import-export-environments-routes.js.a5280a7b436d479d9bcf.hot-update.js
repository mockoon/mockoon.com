...
function ImportExportEnvironmentsRoutes() {
  return __jsx(_components_tutorial__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    __self: this
  }, "Any type of export can be imported from a JSON file: environments or single environment and route copied to clipboard and saved to a JSON file. Environments imported from a file will be added at the end of the environments list. No data will be overwritten even if imported environments share the same names. Imported routes will be added to the active environment.")), __jsx("div", {
    className: "content",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 39
...
//# sourceMappingURL=import-export-environments-routes.js.a5280a7b436d479d9bcf.hot-update.js.map