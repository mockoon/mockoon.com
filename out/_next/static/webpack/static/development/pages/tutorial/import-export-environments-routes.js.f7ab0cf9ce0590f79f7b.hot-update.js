...
function ImportExportEnvironmentsRoutes() {
  return __jsx(_components_tutorial__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    __self: this
  }, "Exported data will be independent of Mockoon's version. You can import then in a more recent version and data will be migrated. Once migrated environments cannot be imported anymore in an older version.")), __jsx("div", {
    className: "content",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18
...
//# sourceMappingURL=import-export-environments-routes.js.f7ab0cf9ce0590f79f7b.hot-update.js.map