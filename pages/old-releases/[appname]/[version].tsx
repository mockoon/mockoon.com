...
export async function getStaticProps({
  ...
  const fileContent =
    await require(`../../../content/old-releases/${params.appname}/${params.version}.md`);
...
export default function OldRelease(props: {
  ...
  return (
    <Layout footerBanner='newsletter'>
      <Meta
        ...
        ogType='article'
        url={`/old-releases/${props.app.appname}/${props.version}/`}
      />

      <Breadcrumb
        currentTitle={`v${props.version}`}
        parentLink={`/old-releases/${props.app.appname}/`}
