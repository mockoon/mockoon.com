...
export default function OldReleasesIndex(props: {
  ...
  return (
    <Layout footerBanner='download'>
      <Meta
        ...
        url={`/old-releases/${props.app.appname}/`}
      />
                ...
                return (
                  <div key={`release${releaseIndex}`} className='mb-12'>
                    <h2 id={`${release.version}`}>
                      <a
                        href={`/old-releases/${props.app.appname}/${release.version}/`}
                        className='display-4'
                      >
                        {`${release.version}`}
                      </a>
