    ...
    items: [
      {
        ...
        answer:
          '<p>We plan to provide the following services:</p><ul><li>Data synchronization for individual developers (2023).</li><li>AI-powered API mocks generation (2023).</li><li>Data synchronization for teams (no ETA).</li><li>Cloud deployment of mock APIs (no ETA).</li></ul>'
      },
      {
  ...
  return (
    <Layout footerBanner='newsletter'>
      ...
      <Hero
        ...
        subtitle="We are building a cloud platform for Mockoon with some exciting features such as data synchronization and AI-powered API mocks generation. Join the waitlist for our beta program and we'll let you know when the services are generally available."
