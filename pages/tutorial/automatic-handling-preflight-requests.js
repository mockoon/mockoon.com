...
function AutomaticHandlingPreflightRequests() {
  return (
    <Tutorial meta={meta}>
      <div className="content">
        When mocking, chances are front application and mocked API won’t be on the <strong>same domain</strong>, thus triggering browsers OPTIONS preflight requests.<br />Failing to answer to these requests may prevent your application from working. Luckily, Mockoon can handle this for you:
        <ol>
      ...
      <div className="content">
        ...
        <p><code>Access-Control-Allow-Origin: *</code><br /><code>Access-Control-Allow-Methods: GET,POST,PUT,PATCH,DELETE,HEAD,OPTIONS</code><br /><code>Access-Control-Allow-Headers: Content-Type, Origin, Accept, Authorization, Content-Length, X-Requested-With</code><br /></p>
        <p>Mockoon won’t send any CORS header if you define a route with the OPTIONS method in your environment (i.e. <code>OPTIONS /my-route</code>), leaving you in full control of the headers you want to add.</p>
      </div>
    </Tutorial>
  );
}
