...
function DefineResponseHeaders() {
  return (
    <Tutorial meta={meta}>
      ...
      <div className="columns">
        <div className="column is-8 is-offset-2">
          <figure className="image">
            <img src="/static/images/tutorials/add-route-header.gif" alt="Add route response header" />
          </figure>
        </div>
      </div>
      <div className="content">
      ...
      <div className="columns">
        <div className="column is-8 is-offset-2">
          <figure className="image">
            <img src="/static/images/tutorials/add-environment-header.gif" alt="Add environment response header" />
          </figure>
        </div>
      </div>
    </Tutorial>
