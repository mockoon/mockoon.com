  ...
  return (
    <Tutorial meta={meta}>
      ...
      <div className="content">
        ...
        <p><code>GET /user/123456?name=john<br />Accept-Language: fr-FR,fr;q=0.9,en-US;q=0.8,en;q=0.7<br />Body:<br />&#123;<br />  "element": [&#123;"title": "My title"&#125;]<br />&#125;</code><br /><br />Response:<br /><code>&#123;<br />  "userId": "5",<br />  "name": "john",<br />  "lang": "fr-FR,fr;q=0.9,en-US;q=0.8,en;q=0.7",<br />  "elementTitle": "My title",<br />  "ip": "::1",<br />  "method": "GET",<br />  "hostname": "localhost",<br />  "friends": [<br />    &#123;<br />      "id": 0,<br />      "name": "Stephen Bradbury"<br />    &#125;,<br />    &#123;<br />      "id": 1,<br />      "name": "Warren Caffey"<br />    &#125;<br />  ],<br />  "oneItem":"item1",<br />  "someItemsAsString":"item2",<br />  "someItemsAsArray":["item2", "item3"],<br />  "userName":"John"<br />&#125;</code></p>
