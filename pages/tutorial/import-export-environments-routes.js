  ...
  return (
    <Tutorial meta={meta}>
      ...
      <div className="columns">
        <div className="column is-8 is-offset-2">
          <figure className="image">
            <img src="/static/images/tutorials/export-all-environments.gif" alt="Export all environments" />
          </figure>
        </div>
      </div>
      <div className="content">
      ...
      <div className="columns">
        <div className="column is-8 is-offset-2">
          <figure className="image">
            <img src="/static/images/tutorials/import-all-environments.gif" alt="Import environments from a file" />
          </figure>
        </div>
      </div>
      <div className="content">
      ...
      <div className="columns">
        <div className="column is-8 is-offset-2">
          <figure className="image">
            <img src="/static/images/tutorials/export-environment-clipboard.gif" alt="Copy environment JSON data to the clipboard" />
          </figure>
        </div>
      </div>
      <div className="content">
      ...
      <div className="columns">
        <div className="column is-8 is-offset-2">
          <figure className="image">
            <img src="/static/images/tutorials/import-environment-clipboard.gif" alt="Import environment JSON data from the clipboard" />
          </figure>
        </div>
      </div>
      <div className="content">
